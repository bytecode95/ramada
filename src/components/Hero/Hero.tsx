...
function Hero() {
  ...
  return (
    <section className="max-width-container bg-cover bg-center relative hero-img-container" id="hero" >
      ...
      <div className="absolute md:top-[150px] 2xl:top-[300px] 2xl:left-[16%] left-[10%] text-white md:w-[700px] 2xl:w-[825px] text-left">
        <h1 className="hero-text-main">{title}</h1>
        <p className="hero-text-description">{description}</p>
      </div>
      <div className="absolute md:top-[450px] 2xl:top-[750px]">
